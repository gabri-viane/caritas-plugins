...
public class FamPicker {
    ...
    public static PickerDialogCNTRL<Famiglia, FamigliaHolder> createPicker() {
        ReferenceQuery<Famiglia, FamigliaHolder> rq = new ReferenceQuery<>(PluginRegisterFamiglie.frr, Famiglia.class, SharedReferenceQuery.getController(FamiglieController.class).getRH(), 9);
